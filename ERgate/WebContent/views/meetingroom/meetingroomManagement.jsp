...
<style>
	...
	.mmName, .mmLocation, .mmPersonnel, .mmNameEdit, .mmLocationEdit, .mmPersonnelEdit{
		height: 60px;
	}
				...
				<div>
					<table class="meetingroomEnroll">
						<tr>
							...
							<td class="mmName2"><input type="text"></td>
						</tr>

						<tr>
							<td class="mmLocation">회의실 위치</td>
							<td class="mmLocation2"><input type="text"></td>
						</tr>

						<tr>
							<td class="mmPersonnel">최대 수용인원</td>
							<td class="mmPersonnel2"><input type="text"></td>
						</tr>
						...
						<tr>
							...
							<td class="mmImgEnroll2">
								<div class="meetingroomImg">
									<img id="mmEnrollImg" class="mmImg" src="${ pageContext.servletContext.contextPath }/resources/siteImg/크기변환_KENN4462-1.jpg">
								</div>
							</td>
						</tr>
			...
			<div class="modal-content">
				<div>
	                <table class="meetingroomEdit">
	                    <tr>
	                        <td class="mmNameEdit">회의실 명</td>
	                        <td class="mmNameEdit2"> <input type="text" value="  &nbsp;3층 회의실1"></td>
	                    </tr>
	                    <tr>
	                        <td class="mmLocationEdit">회의실 위치</td>
	                        <td class="mmLocationEdit2"><input type="text" value="  &nbsp; 3층"> </td>
	                    </tr>
	                    <tr>
	                        <td class="mmPersonnelEdit">최대 수용인원</td>
	                        <td class="mmPersonnelEdit2"><input type="text" value="  &nbsp; 6명"> </td>
	                    </tr>
	                    <tr>
	                        <td class="mmImgEdit">회의실 이미지</td>
	                        <td class="mmImgEdit2"> 
	                            <div class="meetingroomImg">
	                                <img id="mmEditImg" class="mmImg" src="${ pageContext.servletContext.contextPath }/resources/siteImg/크기변환_KENN4462-1.jpg">
	                            </div> 
	                    	</td>
	                    </tr>
	                </table>
