			...
			<table class="boardTable mailTable">
				<thead>
					<tr>
						...
						<th width="50">
								<label><input type="checkbox" class="importbox" id="importAll" name="ichk"><img src="../../resources/icons/star-black-48dp.svg"></label>
						</th>
						<th width="150">계정</th>
						<th width="500">제목</th>
				...
				<tr>
					...
					<td>
						<label><input type="checkbox" class="importbox" name="ichk"><img src="../../resources/icons/star-black-48dp.svg"></label>
					</td>
