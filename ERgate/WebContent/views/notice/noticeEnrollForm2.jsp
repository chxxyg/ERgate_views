...
<body>
	...
	<div class="outer">
		...
		<div class="contentArea">
			...
			<form name="noticeEnroll" action="test.no" method="get" enctype="multipart/form-data">
				<table id="noticeDetail">
					...
					<tr>
						...
						<td colspan="6"><button type="button" class="bigBtn"
								onclick="addFile();">추가</button> &nbsp;&nbsp;<a href="#">첨부파일.jpg</a>
							<input id="addFiles" type="file" name="noticeFile" multiple>
							<div id="dropZone"
			...
			<br>
			<div id="btnArea">
				<button id="submitNotice" class="bigBtn"
